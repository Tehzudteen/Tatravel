<template>
  <div class=" justify-center relative flex flex-2 my-2 mx-3 align-center">
    <div class="relative flex flex-col rounded-xl bg-transparent border-blue-400 border-4 p-4 ">
